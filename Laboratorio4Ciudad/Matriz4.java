...
public class Matriz4 {
    ...
    public static void ortho(float[] r, float izq, float der, float abj, float arr, float
            cerca, float lejos) {
        r[0] = 2 / (der - izq);
        r[4] = 0;
        r[8] = 0;
    ...
    public static void frustum(float[] r, float izq, float der, float abj, float arr, float
            cerca, float lejos) {
        r[0] = 2 * cerca / (der - izq);
        r[4] = 0;
        r[8] = (der + izq) / (der - izq);
    ...
    public static void perspective(float[] r, float fovy, float aspecto, float cerca, float
            lejos) {
    ...
    /* Camara - gluLookAt */
    public static void lookAt(float[] r, float vistaX, float vistaY, float vistaZ, float
            centroX,
...
//v.normaliza(); // No es necesario!
        ...
        r[8] = u.getZ();
        r[12] = -(vistaX * u.getX() +
                vistaY * u.getY() + vistaZ * u.getZ());
        r[1] = v.getX();
        r[5] = v.getY();
        r[9] = v.getZ();
        r[13] = -(vistaX * v.getX() +
                vistaY * v.getY() + vistaZ * v.getZ());
        r[2] = n.getX();
        r[6] = n.getY();
        r[10] = n.getZ();
        r[14] = -(vistaX * n.getX() +
                vistaY * n.getY() + vistaZ * n.getZ());
        r[3] = 0;
        r[7] = 0;
        r[11] = 0;
        r[15] =
